...
use BitBag\SyliusBonusPointsPlugin\Assigner\BonusPointsAssignerInterface;
...
class BonusPointsAssignerCustom implements BonusPointsAssignerInterface
{
    ...
    public function assign(OrderInterface $order): void
    {
        ...
        $usableBonusPointsTotal = $bonusPointsTotal / 100;
        $bonusPointsTotal = (int)(floor($usableBonusPointsTotal) * 100);
